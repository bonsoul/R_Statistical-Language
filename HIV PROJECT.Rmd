...
logit_model <- glm(monthsantibodytest_binary ~ age + weightkg + maritalstatus + residence, 
...
cox_model <- coxph(Surv(time, monthsantibodytest) ~ 
                    subcounty + maritalstatus + hivstatusbeforepregnancy + 
                    miscarriage + haartduringpregnancy + historyofstiduringpregnancy + 
                    hemoglobinlevelduringpregnancy + durationofbfmonths,
                   data = df)
...
logit_model <- glm(subcounty+monthsantibodytest ~ age + weightkg + maritalstatus + residence, 
                   data = df, family = binomial)
summary(logit_model)

capture.output(summary(logit_model), file = "logit_model_summary.txt")
